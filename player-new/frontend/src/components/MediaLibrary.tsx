          ...
          <motion.div key={selectedPlaylist.id} initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col gap-2">
            <div className="flex items-center gap-3 mb-2">
              <button onClick={() => setSelectedPlaylist(null)}
                className="text-[#b3b3b3] hover:text-white transition-colors p-1 cursor-pointer"
              >
              ...
              <span className="text-xs text-[#b3b3b3] ml-auto">{selectedPlaylist.track_count} треков</span>
            </div>
